...
// XML document found at '\src\NET35.DemoLinkedin\..\LinkedInApi.xml'

#region ReturnTypes for Profiles

// WriteReturnTypes(Profiles, person)
namespace DemoLinkedin.Profiles
{
    using System;
    ...
    public class Person
    {
        ...
        public DemoLinkedin.Common.Share CurrentShare { get; set; }
...
namespace DemoLinkedin.Companies
{
    using System;
    using System.Collections.Generic;
    using System.Xml.Serialization;
...
namespace DemoLinkedin.Companies
{
    ...
    public class CompanyUpdateComment
    {
        ...
        [XmlElement(ElementName = "person")]
        [JsonProperty(PropertyName = "person")]
        public DemoLinkedin.Profiles.Person Person { get; set; }
        ...
        [XmlElement(ElementName = "company")]
        [JsonProperty(PropertyName = "company")]
        public DemoLinkedin.Companies.Company Company { get; set; }
...
namespace DemoLinkedin.Companies
{
    ...
    public class CompanyStatusUpdate
    {
        ...
        public DemoLinkedin.Common.Share Share { get; set; }
